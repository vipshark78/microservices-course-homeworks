...
import (
	v1 "github.com/vipshark78/microservices-course-homeworks/shared/pkg/proto/common/v1"
...
// Возвращает UUID зарегистрированного пользователя.
...
// GetUserResponse ответ на получение информации о пользователе.
...
// UserRegistrationInfo информация о пользователе.
...
const file_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x12user/v1/user.proto\x12\auser.v1\x1a\x16common/v1/common.proto\"D\n" +
	...
	"\bpassword\x18\x02 \x01(\tR\bpassword2\x8c\x01\n" +
	"\vUserService\x12?\n" +
	"\bRegister\x12\x18.user.v1.RegisterRequest\x1a\x19.user.v1.RegisterResponse\x12<\n" +
	"\aGetUser\x12\x17.user.v1.GetUserRequest\x1a\x18.user.v1.GetUserResponseBWZUgithub.com/vipshark78/microservices-course-homeworks/shared/pkg/proto/user/v1;user_v1b\x06proto3"
...
var file_user_v1_user_proto_depIdxs = []int32{
	4, // 0: user.v1.RegisterRequest.info:type_name -> user.v1.UserRegistrationInfo
	5, // 1: user.v1.GetUserResponse.user:type_name -> common.v1.User
	6, // 2: user.v1.UserRegistrationInfo.info:type_name -> common.v1.UserInfo
