...
func (_m *PaymentClient) PayOrder(ctx context.Context, payOrder model.PayOrder) (string, error) {
...
func (_e *PaymentClient_Expecter) PayOrder(ctx interface{}, payOrder interface{}) *PaymentClient_PayOrder_Call {
	return &PaymentClient_PayOrder_Call{Call: _e.mock.On("PayOrder", ctx, payOrder)}
}

func (_c *PaymentClient_PayOrder_Call) Run(run func(ctx context.Context, payOrder model.PayOrder)) *PaymentClient_PayOrder_Call {
...
func (_c *PaymentClient_PayOrder_Call) RunAndReturn(run func(context.Context, model.PayOrder) (string, error)) *PaymentClient_PayOrder_Call {
	_c.Call.Return(run)
	return _c
}
